...
cv2.resizeWindow("Image", 1200, 720)  # Set desired width and height
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            elif classNames[cls] == 'Gloves':
                color = (255, 255, 0)  # Blue for gloves
            else:
                color = (0, 255, 0)  # Green for compliant items
